...
import com.acmedcare.framework.applet.integrate.alipay.support.api.response.AlipayOfflineMaterialImageDownloadResponse;
...
public class AlipayOfflineMaterialImageDownloadRequest implements AlipayRequest<AlipayOfflineMaterialImageDownloadResponse> {
	...
	* 图片id列表
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("image_ids", this.imageIds == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.imageIds, true));
		if(udfParams != null) {
