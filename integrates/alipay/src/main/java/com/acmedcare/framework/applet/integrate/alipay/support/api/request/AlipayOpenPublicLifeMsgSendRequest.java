...
import com.acmedcare.framework.applet.integrate.alipay.support.api.response.AlipayOpenPublicLifeMsgSendResponse;
...
deadline（int）：文章的失效时间，单位秒
	...
	* 生活号视频类消息视频id或url（视频类消息必填，根据来源区分）
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("video_samples", this.videoSamples == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.videoSamples, true));
