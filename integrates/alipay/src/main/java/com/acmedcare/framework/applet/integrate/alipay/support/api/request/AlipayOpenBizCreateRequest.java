...
import com.acmedcare.framework.applet.integrate.alipay.support.api.domain.Gavintest;
...
import com.acmedcare.framework.applet.integrate.alipay.support.api.response.AlipayOpenBizCreateResponse;
...
public class AlipayOpenBizCreateRequest implements AlipayRequest<AlipayOpenBizCreateResponse> {
	...
	* 1
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("a", this.a == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.a, true));
		txtParams.put("b", this.b);
		txtParams.put("de", this.de == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.de, true));
