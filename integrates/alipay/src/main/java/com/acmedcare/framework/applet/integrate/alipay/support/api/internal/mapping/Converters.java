    ...
    public static <T> T convert(Class<T> clazz, Reader reader) throws AlipayApiException {
        ...
        try {
            ...
            for (PropertyDescriptor pd : pds) {
                ...
                List<com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.AlipayFieldMethod> alipayFieldMethods = new ArrayList<com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.AlipayFieldMethod>();

                if (baseFields.contains(itemName) && isResponseClazz) {

                    Field field = AlipayResponse.class.getDeclaredField(itemName);

                    com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.AlipayFieldMethod alipayFieldMethod = new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.AlipayFieldMethod();
                    ...
                    if (overideFields.contains(itemName)) {
                        ...
                        if (field != null) {
                            ...
                            alipayFieldMethod = new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.AlipayFieldMethod();
                            alipayFieldMethod.setField(field);
                            alipayFieldMethod.setMethod(writeMethod);
                            alipayFieldMethods.add(alipayFieldMethod);
                        }
                ...
                // 迭代设置属性
                for (com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.AlipayFieldMethod alipayFieldMethod : alipayFieldMethods) {

                    Field field = alipayFieldMethod.getField();
                    Method method = alipayFieldMethod.getMethod();

                    com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.ApiField jsonField = field.getAnnotation(com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.ApiField.class);
                    if (jsonField != null) {
                        itemName = jsonField.value();
                    }
                    com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.ApiListField jsonListField = field.getAnnotation(com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.ApiListField.class);
