...
import com.acmedcare.framework.applet.integrate.alipay.support.api.response.AlipayMdataTagGetResponse;
...
public class AlipayMdataTagGetRequest implements AlipayRequest<AlipayMdataTagGetResponse> {
	...
	* 用户的支付宝Id
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("required_tags", this.requiredTags == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.requiredTags, true));
