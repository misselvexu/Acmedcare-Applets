...
import com.acmedcare.framework.applet.integrate.alipay.support.api.response.AlipayPassCodeAddResponse;
...
2-	支付宝userId
	...
	* 该pass的核销方式,如果为空，则默认为["wave","qrcode"]
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("verify_type", this.verifyType == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.verifyType, true));
		if(udfParams != null) {
