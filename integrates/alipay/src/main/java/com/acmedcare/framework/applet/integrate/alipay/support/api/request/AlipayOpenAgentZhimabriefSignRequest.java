...
import com.acmedcare.framework.applet.integrate.alipay.support.api.domain.ContactModel;
...
import com.acmedcare.framework.applet.integrate.alipay.support.api.response.AlipayOpenAgentZhimabriefSignResponse;
...
">商家经营类目</a> 中的“需要的特殊资质证书”，最小5KB，图片格式必须为：png、bmp、gif、jpg、jpeg
	...
	* 微信公众号名称（1 app_name、app_demo；2 web_sites；3 alipay_life_name；4 wechat_official_account_name。1、2、3、4至少选择一个填写）
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("dr_contact", this.drContact == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.drContact, true));
		...
		txtParams.put("oh_contact", this.ohContact == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.ohContact, true));
		txtParams.put("pr_contact", this.prContact == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.prContact, true));
		txtParams.put("usage_scene", this.usageScene == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.usageScene, true));
		txtParams.put("web_sites", this.webSites == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.webSites, true));
