...
import com.acmedcare.framework.applet.integrate.alipay.support.api.domain.RegionInfo;
...
import com.acmedcare.framework.applet.integrate.alipay.support.api.response.AlipayOpenMiniVersionAuditApplyResponse;
...
public class AlipayOpenMiniVersionAuditApplyRequest implements AlipayUploadRequest<AlipayOpenMiniVersionAuditApplyResponse> {
	...
	* 小程序版本描述，30-500个字符
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("service_region_info", this.serviceRegionInfo == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.serviceRegionInfo, true));
