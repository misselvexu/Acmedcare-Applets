package com.acmedcare.framework.applet.integrate.alipay.support.api.internal.parser.json;

import com.acmedcare.framework.applet.integrate.alipay.support.api.*;
import com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.Converter;
import com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.Converters;
import com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.Reader;
import com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.AlipaySignature;
import com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.SignSourceData;
import com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.StringUtils;
import com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.ExceptionErrorListener;
import com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONReader;
import com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONValidatingReader;
...
public class JsonConverter implements Converter {
    ...
    /**
     * @see com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.Converter#getSignItem(com.acmedcare.framework.applet.integrate.alipay.support.api.AlipayRequest, String)
     */
    ...
    /**
     * @see com.acmedcare.framework.applet.integrate.alipay.support.api.internal.mapping.Converter#getCertItem(com.acmedcare.framework.applet.integrate.alipay.support.api.AlipayRequest, String)
     */
