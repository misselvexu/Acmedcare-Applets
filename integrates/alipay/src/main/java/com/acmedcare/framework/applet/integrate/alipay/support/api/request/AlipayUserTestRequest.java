...
import com.acmedcare.framework.applet.integrate.alipay.support.api.response.AlipayUserTestResponse;
...
public class AlipayUserTestRequest implements AlipayRequest<AlipayUserTestResponse> {
	...
	* 顶顶顶
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("userinfo", this.userinfo == null? null : new com.acmedcare.framework.applet.integrate.alipay.support.api.internal.util.json.JSONWriter().write(this.userinfo, true));
		if(udfParams != null) {
