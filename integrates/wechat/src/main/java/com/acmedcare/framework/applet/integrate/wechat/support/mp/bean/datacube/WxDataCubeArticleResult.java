 ...
 * 图文分析数据接口返回结果对象
 *
 * <p>Created by Acmedcare+ Developer on 2016/8/24.
 *
...
public class WxDataCubeArticleResult extends WxDataCubeBaseResult {
  ...
  /**
   * msgid 请注意：这里的msgid实际上是由msgid（图文消息id，这也就是群发接口调用后返回的msg_data_id） 和index（消息次序索引）组成， 例如12003_3，
  ...
  public static List<WxDataCubeArticleResult> fromJson(String json) {
    return WxMpGsonBuilder.create()
        .fromJson(
            ...
            new TypeToken<List<WxDataCubeArticleResult>>() {}.getType());
  }
}
