...
import com.acmedcare.framework.applet.integrate.wechat.support.common.bean.WxCardApiSignature;
...
import com.acmedcare.framework.applet.integrate.wechat.support.mp.api.WxMpCardService;
...
/**
 * Created by Acmedcare+ Developer on 2016/7/27.
 *
 * @author BinaryWang
 */
@Slf4j
...
public class WxMpCardServiceImpl implements WxMpCardService {
      ...
      if (this.getWxMpService().getWxMpConfigStorage().isTicketExpired(type)) {
        String responseContent =
            this.wxMpService.execute(
                SimpleGetRequestExecutor.create(this.getWxMpService().getRequestHttp()),
                WxMpApiUrl.Card.CARD_GET_TICKET,
                null);
        ...
        this.getWxMpService()
            ...
            .updateTicket(type, cardApiTicket, expiresInSeconds);
      }
    } finally {
      lock.unlock();
    }
  ...
  @Override
  public WxCardApiSignature createCardApiSignature(String... optionalSignParam)
  ...
  public String decryptCardCode(String encryptCode) throws WxErrorException {
    ...
    String responseContent =
        this.wxMpService.post(WxMpApiUrl.Card.CARD_CODE_DECRYPT, param.toString());
    JsonElement tmpJsonElement = new JsonParser().parse(responseContent);
    JsonObject tmpJsonObject = tmpJsonElement.getAsJsonObject();
  ...
  public WxMpCardResult queryCardCode(String cardId, String code, boolean checkConsume)
    ...
    return WxMpGsonBuilder.create()
        .fromJson(tmpJsonElement, new TypeToken<WxMpCardResult>() {}.getType());
  }
  ...
  @Override
  public void markCardCode(String code, String cardId, String openId, boolean isMark)
      throws WxErrorException {
    JsonObject param = new JsonObject();
    param.addProperty("code", code);
    param.addProperty("card_id", cardId);
    ...
    String responseContent =
        this.getWxMpService().post(WxMpApiUrl.Card.CARD_CODE_MARK, param.toString());
    JsonElement tmpJsonElement = new JsonParser().parse(responseContent);
    WxMpCardResult cardResult =
  ...
  public String getCardDetail(String cardId) throws WxErrorException {
    ...
    if (!"0".equals(errcode)) {
      ...
      throw new WxErrorException(
          WxError.builder().errorCode(Integer.valueOf(errcode)).errorMsg(errmsg).build());
    }
  ...
  @Override
  public WxMpCardCreateResult createCard(WxMpCardCreateMessage cardCreateMessage)
      throws WxErrorException {
    String response =
        this.wxMpService.post(WxMpApiUrl.Card.CARD_CREATE, GSON.toJson(cardCreateMessage));
    return WxMpCardCreateResult.fromJson(response);
  }

  @Override
  public WxMpCardQrcodeCreateResult createQrcodeCard(String cardId, String outerStr)
      throws WxErrorException {
    return this.createQrcodeCard(cardId, outerStr, 0);
  }

  @Override
  public WxMpCardQrcodeCreateResult createQrcodeCard(String cardId, String outerStr, int expiresIn)
      throws WxErrorException {
    return this.createQrcodeCard(cardId, outerStr, expiresIn, null, null, false);
  }

  @Override
  public WxMpCardQrcodeCreateResult createQrcodeCard(
      String cardId,
      String outerStr,
      int expiresIn,
      String openid,
    ...
    return WxMpCardQrcodeCreateResult.fromJson(
        this.wxMpService.post(WxMpApiUrl.Card.CARD_QRCODE_CREATE, GSON.toJson(jsonObject)));
  }

  @Override
  public WxMpCardLandingPageCreateResult createLandingPage(WxMpCardLandingPageCreateRequest request)
      throws WxErrorException {
    String response =
        this.wxMpService.post(WxMpApiUrl.Card.CARD_LANDING_PAGE_CREATE, GSON.toJson(request));
    return WxMpCardLandingPageCreateResult.fromJson(response);
  }

  @Override
  public String unavailableCardCode(String cardId, String code, String reason)
      throws WxErrorException {
