...
import com.acmedcare.framework.applet.integrate.wechat.support.open.util.WxOpenCryptUtil;
import com.acmedcare.framework.applet.integrate.wechat.support.open.util.xml.XStreamTransformer;
...
public class WxOpenXmlMessage implements Serializable {
  ...
  public static String wxMpOutXmlMessageToEncryptedXml(
      WxMpXmlOutMessage message, WxOpenConfigStorage wxOpenConfigStorage) {
   ...
   */
  public static WxOpenXmlMessage fromEncryptedXml(
      String encryptedXml,
  ...
  public static WxMpXmlMessage fromEncryptedMpXml(
      String encryptedXml,
      WxOpenConfigStorage wxOpenConfigStorage,
      String timestamp,
      String nonce,
