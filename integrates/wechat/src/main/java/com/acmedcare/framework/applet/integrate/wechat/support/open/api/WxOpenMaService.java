...
public interface WxOpenMaService extends WxMaService {
   ...
   * </pre>
   */
  String API_GET_ACCOUNT_BASICINFO =
   ...
   *
   * <p>https://open.weixin.qq.com/cgi-bin/showdocument?action=dir_list&t=resource/res_list&verify=1&id=open1489140610_Uavc4&token=fe774228c66725425675810097f9e48d0737a4bf&lang=zh_CN
   */
   ...
   */
  WxOpenMaDomainResult modifyDomain(
      String action,
  ...
  WxOpenMaSubmitAuditResult submitAudit(WxOpenMaSubmitAuditMessage submitAuditMessage)
      throws WxErrorException;
  ...
  /** 15. 小程序审核撤回 单个帐号每天审核撤回次数最多不超过1次，一个月不超过10次。 */
