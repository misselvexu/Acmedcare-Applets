...
import com.acmedcare.framework.applet.integrate.wechat.support.mp.bean.WxMpMassTagMessage;
...
public class WxMpMassTagMessageGsonAdapter implements JsonSerializer<WxMpMassTagMessage> {
  ...
  public JsonElement serialize(
      WxMpMassTagMessage message, Type typeOfSrc, JsonSerializationContext context) {
