...
public class StandardSession implements WxSession, InternalSession {
  ...
  /**
   * We are currently processing a session expiration, so bypass certain IllegalStateException
   * tests. NOTE: This value is not included in the serialized version of this object.
   */
  ...
  /**
   * The facade associated with this session. NOTE: This value is not included in the serialized
  ...
  public void setAttribute(String name, Object value) {
    ...
    if (!isValidInternal()) {
      throw new IllegalStateException(
          SM.getString("sessionImpl.setAttribute.ise", getIdInternal()));
    }
  ...
  /**
   * Return the names of all currently defined session attributes as an array of Strings. If there
   * are no defined attributes, a zero-length array is returned.
   */
