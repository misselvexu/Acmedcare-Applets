...
/**
 * 模板消息. 参考 http://mp.weixin.qq.com/wiki?t=resource/res_main&id=mp1433751277&token=&lang=zh_CN
 * 发送模板消息接口部分
 *
...
public class WxMpTemplateMessage implements Serializable {
  ...
  /** 模板数据. */
  @Builder.Default private List<WxMpTemplateData> data = new ArrayList<>();
