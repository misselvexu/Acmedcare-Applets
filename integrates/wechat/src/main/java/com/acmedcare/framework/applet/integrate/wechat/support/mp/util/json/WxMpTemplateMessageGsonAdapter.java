...
import com.acmedcare.framework.applet.integrate.wechat.support.mp.bean.template.WxMpTemplateData;
...
public class WxMpTemplateMessageGsonAdapter implements JsonSerializer<WxMpTemplateMessage> {
  ...
  public JsonElement serialize(
      WxMpTemplateMessage message, Type typeOfSrc, JsonSerializationContext context) {
