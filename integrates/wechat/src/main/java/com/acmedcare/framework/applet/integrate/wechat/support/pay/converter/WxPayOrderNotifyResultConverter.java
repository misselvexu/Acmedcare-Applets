package com.acmedcare.framework.applet.integrate.wechat.support.pay.converter;

import com.acmedcare.framework.applet.integrate.wechat.support.pay.bean.notify.WxPayOrderNotifyCoupon;
...
public class WxPayOrderNotifyResultConverter extends AbstractReflectionConverter {
  ...
  private void setFieldValue(
      UnmarshallingContext context, WxPayOrderNotifyResult obj, Field field) {
  ...
  private WxPayOrderNotifyCoupon getElement(
      Map<Integer, WxPayOrderNotifyCoupon> coupons, String nodeName) {
