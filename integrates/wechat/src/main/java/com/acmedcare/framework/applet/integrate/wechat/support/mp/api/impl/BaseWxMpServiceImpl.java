...
import com.acmedcare.framework.applet.integrate.wechat.support.common.util.DataUtils;
...
import com.acmedcare.framework.applet.integrate.wechat.support.common.util.http.*;
import com.acmedcare.framework.applet.integrate.wechat.support.mp.api.*;
import com.acmedcare.framework.applet.integrate.wechat.support.mp.bean.WxMpSemanticQuery;
import com.acmedcare.framework.applet.integrate.wechat.support.mp.bean.result.WxMpCurrentAutoReplyInfo;
...
import com.acmedcare.framework.applet.integrate.wechat.support.mp.util.WxMpConfigStorageHolder;
...
public abstract class BaseWxMpServiceImpl<H, P> implements WxMpService, RequestHttp<H, P> {
    ...
    try {
      ...
      if (this.getWxMpConfigStorage().isTicketExpired(type)) {
        String responseContent =
            execute(
                SimpleGetRequestExecutor.create(this),
                WxMpApiUrl.Other.GET_TICKET_URL.getUrl(this.getWxMpConfigStorage())
                    + type.getCode(),
                null);
  ...
  public WxMpSemanticQueryResult semanticQuery(WxMpSemanticQuery semanticQuery)
    ...
    String responseContent =
        this.post(WxMpApiUrl.Other.SEMANTIC_SEMPROXY_SEARCH_URL, semanticQuery.toJson());
  ...
  public String oauth2buildAuthorizationUrl(String redirectURI, String scope, String state) {
    return String.format(
        WxMpApiUrl.Other.CONNECT_OAUTH2_AUTHORIZE_URL.getUrl(this.getWxMpConfigStorage()),
  ...
  public String buildQrConnectUrl(String redirectURI, String scope, String state) {
    return String.format(
        WxMpApiUrl.Other.QRCONNECT_URL.getUrl(this.getWxMpConfigStorage()),
        this.getWxMpConfigStorage().getAppId(),
        URIUtil.encodeURIComponent(redirectURI),
        scope,
        StringUtils.trimToEmpty(state));
  ...
  public WxMpOAuth2AccessToken oauth2getAccessToken(String code) throws WxErrorException {
    String url =
        String.format(
            WxMpApiUrl.Other.OAUTH2_ACCESS_TOKEN_URL.getUrl(this.getWxMpConfigStorage()),
            this.getWxMpConfigStorage().getAppId(),
  ...
  public WxMpOAuth2AccessToken oauth2refreshAccessToken(String refreshToken)
    ...
    String url =
        String.format(
            WxMpApiUrl.Other.OAUTH2_REFRESH_TOKEN_URL.getUrl(this.getWxMpConfigStorage()),
            this.getWxMpConfigStorage().getAppId(),
            refreshToken);
    return this.getOAuth2AccessToken(url);
  }
  ...
  @Override
  public WxMpUser oauth2getUserInfo(WxMpOAuth2AccessToken token, String lang)
      throws WxErrorException {
    if (lang == null) {
      lang = "zh_CN";
    }
    ...
    String url =
        String.format(
            WxMpApiUrl.Other.OAUTH2_USERINFO_URL.getUrl(this.getWxMpConfigStorage()),
  ...
  public boolean oauth2validateAccessToken(WxMpOAuth2AccessToken token) {
    String url =
        String.format(
            WxMpApiUrl.Other.OAUTH2_VALIDATE_TOKEN_URL.getUrl(this.getWxMpConfigStorage()),
            token.getAccessToken(),
            token.getOpenId());
  ...
  public WxMpCurrentAutoReplyInfo getCurrentAutoReplyInfo() throws WxErrorException {
    return WxMpCurrentAutoReplyInfo.fromJson(
        this.get(WxMpApiUrl.Other.GET_CURRENT_AUTOREPLY_INFO_URL, null));
  }
  ...
  @Override
  public <T, E> T execute(RequestExecutor<T, E> executor, WxMpApiUrl url, E data)
      throws WxErrorException {
  ...
  public void setMultiConfigStorages(
      Map<String, WxMpConfigStorage> configStorages, String defaultMpId) {
