...
public interface InternalSessionManager {
  ...
  /**
   * Get a session from the recycled ones or create a new empty one. The PersistentManager manager
   * does not need to create session data because it reads it from the Store.
   */
