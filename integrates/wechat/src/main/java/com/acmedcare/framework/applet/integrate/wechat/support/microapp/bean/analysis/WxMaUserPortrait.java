...
public class WxMaUserPortrait implements Serializable {
  ...
  public static class Item {
    /** key: 省份，如北京、广东等 value: 活跃用户数或新用户数 */
    private Map<String, Long> province;
    /** key: 城市，如北京、广州等 value: 活跃用户数或新用户数 */
    private Map<String, Long> city;
    /** key: 性别，包括男、女、未知 value: 活跃用户数或新用户数 */
    private Map<String, Long> genders;
    /** key: 终端类型，包括iPhone, android,其他 value: 活跃用户数或新用户数 */
    private Map<String, Long> platforms;
    /** key: 机型，如苹果iPhone6, OPPO R9等 value: 活跃用户数或新用户数 */
    private Map<String, Long> devices;
    /** key: 年龄，包括17岁以下、18-24岁等区间 value: 活跃用户数或新用户数 */
