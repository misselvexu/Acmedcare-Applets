...
import com.acmedcare.framework.applet.integrate.wechat.support.mp.bean.card.enums.CardWechatFieldType;
...
public class MemberCardUserForm implements Serializable {
  ...
  /** 当前结构（required_form或者optional_form ）内的字段是否允许用户激活后再次修改， 商户设置为true 时，需要接收相应事件通知处理修改事件 */
