package com.acmedcare.framework.applet.integrate.wechat.support.pay.service;
...
public interface WxPayService {
  ...
  /**
   * 该接口调用“统一下单”接口，并拼装发起支付请求需要的参数. 详见https://pay.weixin.qq.com/wiki/doc/api/app/app.php?chapter=8_5
   *
   * @param request 请求对象，注意一些参数如appid、mchid等不用设置，方法内会自动从配置对象中获取到（前提是对应配置中已经设置）
   * @return the pay info
   * @throws WxPayException the wx pay exception
   ...
   * @throws WxPayException the wx pay exception
   */
  WxPayRefundQueryResult refundQuery(
  ...
  /**
   * 解析扫码支付回调通知 详见https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=6_4
   *
   * @param xmlData the xml data
   ...
   *     WxPayService#authcode2Openid(WxPayAuthcode2OpenidRequest)
   */
   ...
   * @throws WxPayException the wx pay exception
   */
  String queryComment(Date beginDate, Date endDate, Integer offset, Integer limit)
      throws WxPayException;
