 ...
 */
public class QrcodeBytesRequestExecutor
    implements RequestExecutor<byte[], AbstractWxMaQrcodeWrapper> {
  ...
  @Override
  public void execute(String uri, AbstractWxMaQrcodeWrapper data, ResponseHandler<byte[]> handler)
      throws WxErrorException, IOException {
    handler.handle(this.execute(uri, data));
  }

  @Override
  public byte[] execute(String uri, AbstractWxMaQrcodeWrapper qrcodeWrapper)
      throws WxErrorException, IOException {
