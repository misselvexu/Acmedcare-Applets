...
public class WxMpMaterialNewsArticleGsonAdapter
  ...
  public JsonElement serialize(
    ...
    if (null != article.getNeedOpenComment()) {
      articleJson.addProperty(
          "need_open_comment", BooleanUtils.toInteger(article.getNeedOpenComment(), 1, 0));
    }

    if (null != article.getOnlyFansCanComment()) {
      articleJson.addProperty(
          "only_fans_can_comment", BooleanUtils.toInteger(article.getOnlyFansCanComment(), 1, 0));
    }
    return articleJson;
  }

  @Override
  public WxMpMaterialNews.WxMpMaterialNewsArticle deserialize(
