...
public class WxMpMaterialNewsGsonAdapter
  ...
  public JsonElement serialize(
      WxMpMaterialNews wxMpMaterialNews, Type typeOfSrc, JsonSerializationContext context) {
    ...
    for (WxMpMaterialNews.WxMpMaterialNewsArticle article : wxMpMaterialNews.getArticles()) {
      JsonObject articleJson =
          WxMpGsonBuilder.create()
              .toJsonTree(article, WxMpMaterialNews.WxMpMaterialNewsArticle.class)
              .getAsJsonObject();
  ...
  @Override
  public WxMpMaterialNews deserialize(
    ...
    if (json.get("news_item") != null && !json.get("news_item").isJsonNull()) {
      ...
      for (JsonElement article1 : articles) {
        ...
        WxMpMaterialNews.WxMpMaterialNewsArticle article =
            WxMpGsonBuilder.create()
                .fromJson(articleInfo, WxMpMaterialNews.WxMpMaterialNewsArticle.class);
