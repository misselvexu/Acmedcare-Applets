...
public class WxMaRetainInfo implements Serializable {
  ...
  /** 日留存：日期，yyyyMMdd 格式，如 20170313 周留存：时间，如"20170306-20170312" 月留存：时间，如"201702" */
  @SerializedName(value = "refDate", alternate = "ref_date")
  private String refDate;
  /**
   * 新增用户留存 - key: - 日留存：标识，0开始，0表示当天，1表示1天后，依此类推，key取值分别是：0,1,2,3,4,5,6,7,14,30 -
   * 周留存：标识，0开始，0表示当周，1表示1周后，依此类推，key 取值分别是：0,1,2,3,4 - 月留存：标识，0开始，0表示当月，1表示1月后，key取值分别是：0,1 -
