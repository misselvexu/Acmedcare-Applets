...
public interface WxMaAnalysisService {
  ...
  /**
   * 查询概况趋势 温馨提示：小程序接口目前只能查询一天的数据，即 beginDate 和 endDate 一样
   *
  ...
  /**
   * 获取日访问趋势 温馨提示：小程序接口目前只能查询一天的数据，即 beginDate 和 endDate 一样
   *
   * @param beginDate 开始日期
   * @param endDate 结束日期，限定查询1天数据，end_date允许设置的最大值为昨日
   * @return 日访问趋势
  ...
  /**
   * 获取周访问趋势 限定查询一个自然周的数据，时间必须按照自然周的方式输入： 如：20170306(周一), 20170312(周日)
   *
  ...
  /**
   * 获取月访问趋势 限定查询一个自然月的数据，时间必须按照自然月的方式输入： 如：20170201(月初), 20170228(月末)
   *
  ...
  /**
   * 获取访问分布 （此接口目前只能查询一天的数据，即 beginDate 和 endDate 一样）
   *
   * @param beginDate 开始日期，为周一日期
   * @param endDate 结束日期，限定查询1天数据，end_date允许设置的最大值为昨日
   * @return 访问分布
  ...
  /**
   * 日留存 （此接口目前只能查询一天的数据，即 beginDate 和 endDate 一样）
   *
   * @param beginDate 开始日期，为周一日期
  ...
  /**
   * 周留存 限定查询一个自然周的数据，时间必须按照自然周的方式输入： 如：20170306(周一), 20170312(周日)
   *
   * @param beginDate 开始日期，为周一日期
   * @param endDate 结束日期，为周日日期，限定查询一周数据
   * @return 周留存
  ...
  /**
   * 月留存 限定查询一个自然月的数据，时间必须按照自然月的方式输入： 如：20170201(月初), 20170228(月末)
   *
   * @param beginDate 开始日期，为自然月第一天
   * @param endDate 结束日期，为自然月最后一天，限定查询一个月数据
   * @return 月留存
  ...
  /**
   * 获取访问页面数据 温馨提示：此接口目前只能查询一天的数据，即 beginDate 和 endDate 一样
   *
   * @param beginDate 开始日期
   * @param endDate 结束日期，限定查询1天数据，end_date允许设置的最大值为昨日
   * @return 访问页面数据
