...
public interface WxOpenFastMaService extends WxMaService {
  ...
  /** 1 获取帐号基本信息 */
  String OPEN_GET_ACCOUNT_BASIC_INFO =
  ...
  /** 4 微信认证名称检测 */
  String OPEN_CHECK_WX_VERIFY_NICKNAME =
  ...
  /** 7 换绑小程序管理员接口 */
  String OPEN_COMPONENT_REBIND_ADMIN =
   ...
   * @throws WxErrorException
   */
  WxFastMaSetNickameResult setNickname(
      String nickname,
      String idCard,
      String license,
   ...
   * @throws WxErrorException
   */
  WxOpenResult modifyHeadImage(String headImgMediaId, float x1, float y1, float x2, float y2)
      throws WxErrorException;
