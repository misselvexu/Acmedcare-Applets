package com.acmedcare.framework.applet.integrate.wechat.support.pay.config;
...
public class WxPayConfig {
  ...
  /** 是否将接口请求日志信息保存到threadLocal中. 默认不保存 */
  ...
  public SSLContext initSSLContext() throws WxPayException {
    ...
    if (this.keyContent != null) {
      ...
      } else if (this.getKeyPath().startsWith("http://")
          || this.getKeyPath().startsWith("https://")) {
        try {
