...
import com.acmedcare.framework.applet.integrate.wechat.support.microapp.api.*;
...
import static com.acmedcare.framework.applet.integrate.wechat.support.microapp.constant.WxMaConstants.ErrorCode.*;
...
public class WxMaServiceImpl implements WxMaService, RequestHttp<CloseableHttpClient, HttpHost> {
  ...
  private <T, E> T executeInternal(RequestExecutor<T, E> executor, String uri, E data)
      throws WxErrorException {
