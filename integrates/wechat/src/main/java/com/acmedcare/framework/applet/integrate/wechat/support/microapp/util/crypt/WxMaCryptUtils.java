package com.acmedcare.framework.applet.integrate.wechat.support.microapp.util.crypt;

import com.acmedcare.framework.applet.integrate.wechat.support.common.util.crypto.PKCS7Encoder;
...
public class WxMaCryptUtils extends WxCryptUtil {
  ...
  public static String decrypt(String sessionKey, String encryptedData, String ivStr) {
    try {
      ...
      cipher.init(
          Cipher.DECRYPT_MODE, new SecretKeySpec(Base64.decodeBase64(sessionKey), "AES"), params);

      return new String(
          PKCS7Encoder.decode(cipher.doFinal(Base64.decodeBase64(encryptedData))), UTF_8);
    } catch (Exception e) {
