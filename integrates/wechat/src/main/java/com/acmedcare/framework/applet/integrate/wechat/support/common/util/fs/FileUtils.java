package com.acmedcare.framework.applet.integrate.wechat.support.common.util.fs;
...
public class FileUtils {
  ...
  public static File createTmpFile(InputStream inputStream, String name, String ext)
    ...
    return createTmpFile(
        inputStream, name, ext, Files.createTempDirectory("weixin-java-tools-temp").toFile());
  }
}
