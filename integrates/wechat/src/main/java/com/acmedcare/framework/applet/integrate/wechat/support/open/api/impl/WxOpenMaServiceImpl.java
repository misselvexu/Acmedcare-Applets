...
import com.acmedcare.framework.applet.integrate.wechat.support.open.api.WxOpenMaService;
import com.acmedcare.framework.applet.integrate.wechat.support.open.bean.ma.WxMaOpenCommitExtInfo;
import com.acmedcare.framework.applet.integrate.wechat.support.open.bean.ma.WxMaQrcodeParam;
import com.acmedcare.framework.applet.integrate.wechat.support.open.bean.message.WxOpenMaSubmitAuditMessage;
import com.acmedcare.framework.applet.integrate.wechat.support.open.bean.result.*;
import com.acmedcare.framework.applet.integrate.wechat.support.open.util.requestexecuter.ma.MaQrCodeRequestExecutor;
...
public class WxOpenMaServiceImpl extends WxMaServiceImpl implements WxOpenMaService {
  ...
  public WxOpenMaServiceImpl(
      WxOpenComponentService wxOpenComponentService, String appId, WxMaConfig wxMaConfig) {
   ...
   */
  @Override
  public WxOpenMaDomainResult modifyDomain(
      String action,
    ...
    //    if (!"get".equals(action) && (requestdomainList == null || wsrequestdomainList == null ||
    // uploaddomainList == null || downloaddomainList == null)) {
    //      throw new
    // WxErrorException(WxError.builder().errorCode(44004).errorMsg("域名参数不能为空").build());
    //    }
   ...
   */
  @Override
  public WxOpenResult codeCommit(
      Long templateId, String userVersion, String userDesc, WxMaOpenCommitExtInfo extInfo)
      throws WxErrorException {
   ...
   * 获取授权小程序帐号的可选类目
   *
   * <p>注意：该接口可获取已设置的二级类目及用于代码审核的可选三级类目。
   *
   ...
   */
  @Override
  public WxOpenMaSubmitAuditResult submitAudit(WxOpenMaSubmitAuditMessage submitAuditMessage)
      throws WxErrorException {
   ...
   * 15. 小程序审核撤回
   *
   * <p>单个帐号每天审核撤回次数最多不超过1次，一个月不超过10次。
   *
   * @return
   * @throws WxErrorException
   */
