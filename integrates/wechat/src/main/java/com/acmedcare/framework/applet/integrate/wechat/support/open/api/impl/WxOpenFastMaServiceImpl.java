...
import com.acmedcare.framework.applet.integrate.wechat.support.open.api.WxOpenFastMaService;
import com.acmedcare.framework.applet.integrate.wechat.support.open.bean.fastma.WxFastMaCategory;
...
public class WxOpenFastMaServiceImpl extends WxMaServiceImpl implements WxOpenFastMaService {
  ...
  public WxOpenFastMaServiceImpl(
   ...
   */
  @Override
  public WxFastMaSetNickameResult setNickname(
      String nickname,
      String idCard,
      String license,
   ...
   */
  @Override
  public WxFastMaQueryNicknameStatusResult querySetNicknameStatus(String auditId)
      throws WxErrorException {
    JsonObject params = new JsonObject();
   ...
   */
  @Override
  public WxOpenResult modifyHeadImage(String headImgMediaId, float x1, float y1, float x2, float y2)
      throws WxErrorException {
    JsonObject params = new JsonObject();
