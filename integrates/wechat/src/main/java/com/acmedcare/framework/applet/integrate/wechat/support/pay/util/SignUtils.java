package com.acmedcare.framework.applet.integrate.wechat.support.pay.util;
...
public class SignUtils {
  ...
  public static String createSign(
      Object xmlBean, String signType, String signKey, String[] ignoredParams) {
   ...
   */
  public static String createSign(
      Map<String, String> params, String signType, String signKey, String[] ignoredParams) {
    ...
    if (WxPayConstants.SignType.HMAC_SHA256.equals(signType)) {
      return com.acmedcare.framework.applet.integrate.wechat.support.common.util.SignUtils
          .createHmacSha256Sign(toSign.toString(), signKey);
    } else {
