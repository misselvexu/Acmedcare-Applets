...
public class WxPaySendRedpackRequest extends BaseWxPayRequest {
  ...
  /** mch_billno. 商户订单号（每个订单号必须唯一） 组成：mch_id+yyyymmdd+10位一天内不能重复的数字。 接口根据商户订单号支持重入，如出现超时可再调用。 */
  ...
  /** amt_type. 红包金额设置方式 ALL_RAND—全部随机,商户指定总金额和红包发放总人数，由微信支付随机计算出各红包金额 裂变红包必填 */
  @XStreamAlias("amt_type")
  private String amtType;
  /** wishing. 红包祝福语 */
  @XStreamAlias("wishing")
  private String wishing;
  /** client_ip. 服务器Ip地址 调用接口的机器Ip地址 */
  ...
  /**
   * wxappid. 微信分配的公众账号ID（企业号corpid即为此appId）。 接口传入的所有appid应该为公众号的appid（在mp.weixin.qq.com申请的），
