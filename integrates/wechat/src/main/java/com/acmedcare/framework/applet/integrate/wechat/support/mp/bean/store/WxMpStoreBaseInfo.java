...
public class WxMpStoreBaseInfo implements Serializable {
  ...
  /** offsetType 坐标类型，1 为火星坐标（目前只能选1） */
  @Required
  ...
  @SerializedName("sid")
  private String sid;
  /** business_name 门店名称（仅为商户名，如：国美、麦当劳，不应包含地区、地址、分店名等信息，错误示例：北京国美） 不能为空，15个汉字或30个英文字符内 */
  @Required
  @SerializedName("business_name")
  private String businessName;
  /** branch_name 分店名称（不应包含地区信息，不应与门店名有重复，错误示例：北京王府井店） 10个字以内 */
  @Required
  @SerializedName("branch_name")
  private String branchName;
  /** province 门店所在的省份（直辖市填城市名,如：北京市） 10个字以内 */
  @Required
  ...
  @SerializedName("city")
  private String city;
  /** district 门店所在地区 10个字以内 */
  @Required
  @SerializedName("district")
  private String district;
  /** address 门店所在的详细街道地址（不要填写省市信息） （东莞等没有“区”行政区划的城市，该字段可不必填写。其余城市必填。） */
  @Required
  ...
  /**
   * photo_list 图片列表，url 形式，可以有多张图片，尺寸为 640*340px。必须为上一接口生成的url。
   * 图片内容不允许与门店不相关，不允许为二维码、员工合照（或模特肖像）、营业执照、无门店正门的街景、地图截图、公交地铁站牌、菜单截图等
   */
  @SerializedName("photo_list")
  private List<WxMpStorePhoto> photos;
  /** recommend 推荐品，餐厅可为推荐菜；酒店为推荐套房；景点为推荐游玩景点等，针对自己行业的推荐内容 200字以内 */
