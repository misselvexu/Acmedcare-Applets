...
import com.acmedcare.framework.applet.integrate.wechat.support.mp.api.WxMpDataCubeService;
import com.acmedcare.framework.applet.integrate.wechat.support.mp.api.WxMpService;
import com.acmedcare.framework.applet.integrate.wechat.support.mp.bean.datacube.*;
...
/**
 * Created by Acmedcare+ Developer on 2016/8/23.
 *
...
public class WxMpDataCubeServiceImpl implements WxMpDataCubeService {
  ...
  public List<WxDataCubeUserSummary> getUserSummary(Date beginDate, Date endDate)
    ...
    String responseContent =
        this.wxMpService.post(
            WxMpApiUrl.DataCube.GET_USER_SUMMARY, buildParams(beginDate, endDate));
  ...
  public List<WxDataCubeUserCumulate> getUserCumulate(Date beginDate, Date endDate)
    ...
    String responseContent =
        this.wxMpService.post(
            WxMpApiUrl.DataCube.GET_USER_CUMULATE, buildParams(beginDate, endDate));
  ...
  public List<WxDataCubeArticleResult> getArticleSummary(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getArticleResults(WxMpApiUrl.DataCube.GET_ARTICLE_SUMMARY, beginDate, endDate);
  }
  ...
  public List<WxDataCubeArticleTotal> getArticleTotal(Date beginDate, Date endDate)
    ...
    String responseContent =
        this.wxMpService.post(
            WxMpApiUrl.DataCube.GET_ARTICLE_TOTAL, buildParams(beginDate, endDate));
  ...
  public List<WxDataCubeArticleResult> getUserRead(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getArticleResults(WxMpApiUrl.DataCube.GET_USER_READ, beginDate, endDate);
  }

  @Override
  public List<WxDataCubeArticleResult> getUserReadHour(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getArticleResults(WxMpApiUrl.DataCube.GET_USER_READ_HOUR, beginDate, endDate);
  }

  @Override
  public List<WxDataCubeArticleResult> getUserShare(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getArticleResults(WxMpApiUrl.DataCube.GET_USER_SHARE, beginDate, endDate);
  }

  @Override
  public List<WxDataCubeArticleResult> getUserShareHour(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getArticleResults(WxMpApiUrl.DataCube.GET_USER_SHARE_HOUR, beginDate, endDate);
  }

  private List<WxDataCubeArticleResult> getArticleResults(
      WxMpApiUrl url, Date beginDate, Date endDate) throws WxErrorException {
  ...
  public List<WxDataCubeMsgResult> getUpstreamMsg(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getUpstreamMsg(WxMpApiUrl.DataCube.GET_UPSTREAM_MSG, beginDate, endDate);
  }

  @Override
  public List<WxDataCubeMsgResult> getUpstreamMsgHour(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getUpstreamMsg(WxMpApiUrl.DataCube.GET_UPSTREAM_MSG_HOUR, beginDate, endDate);
  }

  @Override
  public List<WxDataCubeMsgResult> getUpstreamMsgWeek(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getUpstreamMsg(WxMpApiUrl.DataCube.GET_UPSTREAM_MSG_WEEK, beginDate, endDate);
  }

  @Override
  public List<WxDataCubeMsgResult> getUpstreamMsgMonth(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getUpstreamMsg(WxMpApiUrl.DataCube.GET_UPSTREAM_MSG_MONTH, beginDate, endDate);
  }

  @Override
  public List<WxDataCubeMsgResult> getUpstreamMsgDist(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getUpstreamMsg(WxMpApiUrl.DataCube.GET_UPSTREAM_MSG_DIST, beginDate, endDate);
  }

  @Override
  public List<WxDataCubeMsgResult> getUpstreamMsgDistWeek(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getUpstreamMsg(WxMpApiUrl.DataCube.GET_UPSTREAM_MSG_DIST_WEEK, beginDate, endDate);
  }

  @Override
  public List<WxDataCubeMsgResult> getUpstreamMsgDistMonth(Date beginDate, Date endDate)
      throws WxErrorException {
    return this.getUpstreamMsg(WxMpApiUrl.DataCube.GET_UPSTREAM_MSG_DIST_MONTH, beginDate, endDate);
  }

  private List<WxDataCubeMsgResult> getUpstreamMsg(WxMpApiUrl url, Date beginDate, Date endDate)
      throws WxErrorException {
    String responseContent = this.wxMpService.post(url, buildParams(beginDate, endDate));
  ...
  public List<WxDataCubeInterfaceResult> getInterfaceSummary(Date beginDate, Date endDate)
    ...
    String responseContent =
        this.wxMpService.post(
            WxMpApiUrl.DataCube.GET_INTERFACE_SUMMARY, buildParams(beginDate, endDate));
  ...
  public List<WxDataCubeInterfaceResult> getInterfaceSummaryHour(Date beginDate, Date endDate)
    ...
    String responseContent =
        this.wxMpService.post(
            WxMpApiUrl.DataCube.GET_INTERFACE_SUMMARY_HOUR, buildParams(beginDate, endDate));
    return WxDataCubeInterfaceResult.fromJson(responseContent);
  }
}
